...
import com.rup.feature.data.remote.dto.map.Dummy
...
import com.rup.feature.data.remote.dto.map.ResultXX
...
class MapViewModel: BaseViewModel() {
    ...
    private val _promise = MutableLiveData<ResultXX?>(null)
